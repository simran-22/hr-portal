...
export default function LoginPage({ searchParams }: { searchParams: Promise<{ registered?: string }> }) {
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-slate-800/50 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-8 shadow-2xl">
          ...
          <form action={action} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  name="email" type="email" required placeholder="admin@hr.com"
          ...
          <p className="text-center text-slate-400 text-sm mt-6">
            ...
            <Link href="/register" className="text-violet-400 hover:text-violet-300 font-medium transition">Create one</Link>
          </p>
        </div>
