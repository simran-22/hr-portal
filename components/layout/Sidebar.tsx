...
import {
  ...
  BarChart3, FolderOpen, GitBranch,
...
const CATEGORIES: Category[] = [
  {
    ...
    items: [
      ...
      { label: "Onboarding",    href: "/onboarding",    icon: UserPlus, adminOnly: true },
      { label: "Offboarding",   href: "/offboarding",   icon: UserMinus, adminOnly: true },
